...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$S6xNaMb/p/9VHoLmTkQmBuc3mipUsdsL1Zy5Jvp57eevZgfkwyNiO';

COMMIT;

UPDATE "MEMBER" SET
MEMBER_NICKNAME = 'USER1',
MEMBER_TEL = '01032702918',
MEMBER_ADDR = '서울시'
WHERE MEMBER_NO = 1;
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_TEL,
       ...
       TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" HH24"시" MI"분" SS"초"') AS ENROLL_DATE
FROM MEMBER
...
INSERT INTO BOARD
VALUES (SEQ_BOARD_NO.NEXTVAL, '테스트 글','테스트 글입니다.',
        DEFAULT , NULL,0 , 'N',1, 3 );
...
-- BOARD_CODE 가 1(공지사항)인 게시글을 최신순으로 조회 (삭제된 글은 제외)
SELECT * FROM BOARD
WHERE BOARD_CODE = 1
AND BOARD_DEL_FL = 'N'
...
VALUES (SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142013_00001.gif', 'cat1.jpg', 0, 1994 );
       
INSERT INTO BOARD_IMG
VALUES (SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142013_00002.gif', 'cat2.jpg', 0, 1988 );
        
INSERT INTO BOARD_IMG
VALUES (SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142013_00003.gif', 'cat3.jpg', 0, 1986 );
        
INSERT INTO BOARD_IMG
VALUES (SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142013_00004.gif', 'cat4.jpg', 0, 1984 );
        
INSERT INTO BOARD_IMG
VALUES (SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142013_00005.gif', 'cat5.jpg', 0, 1966 );
...
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG = '/resources/images/member/로미1.jpg'
WHERE MEMBER_NO = 1;
...
-- 좋아요 테이블 삽입
INSERT INTO BOARD_LIKE VALUES(1994, 15);
COMMIT;
...
-- 1001 1002
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 2011, 1, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 2011, 1, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-1', DEFAULT, DEFAULT, 2011, 1, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-2', DEFAULT, DEFAULT, 2011, 1, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글1-3', DEFAULT, DEFAULT, 2011, 1, 1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-1', DEFAULT, DEFAULT, 2011, 1, 1002);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글2-2', DEFAULT, DEFAULT, 2011, 1, 1002);
