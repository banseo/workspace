...
btn1.addEventListener("click", () => {
    ...
    .then(tel => {
        ...
        console.log(tel) // 조회 결과를 result1에 출력
    })
...
btn3.addEventListener("click", () => {
    ...
    .then(memberList => {
        ...
        if(memberList.length == 0){
            ...
            // 향상된 for문 사용해서 memberList 순차 접근
