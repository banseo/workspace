...
@SessionAttributes({"loginMember"}) // Model의 이름(key)를 적으면 session으로 추가  (여러개일땐 배열 형식으로)  @@@@@@@@@@@@@@@@@@@@@@@@@
public class MemberController {
	
	// 등록된 Bean 중에서 필드와 타입이 일치하는 Bean을 주입
	// -> MemberService를 구현한 MemberServiceImpl의 Bean을 주입  @@@상속
	@Autowired
	...
	public String login(HttpServletRequest req) {
		...
		// Argument Resolver(매개변수 헤결사)가 해결해줘서
	...
	public String signUp(Member inputMember
		...
		// String[] memberAddress : 
		// imput name="memberAddress" 3개가 저장된 배열
