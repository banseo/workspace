...
-- user01  비밀번호 변경
UPDATE MEMBER SET
MEMBER_PW = '$2a$10$.MtvvpC1JjpKcAgU2Facx.bipOcdsmlUzdBpupBppiQnaiJjm6dzy';

COMMIT;

UPDATE MEMBER SET
MEMBER_NICKNAME = 'SSDF',
MEMBER_TEL = 'SDFS',
MEMBER_ADDR = 'SDFSD'
WHERE MEMBER_NO = 1;
...
-- 회원 비번 변경
UPDATE MEMBER SET MEMBER_PW = 'ㄴㅇㄹㅇㄴㄹㄴ' WHERE MEMBER_NO = 1;

-- 이메일 중복 검사
SELECT COUNT(*) FROM MEMBER WHERE MEMBER_EMAIL = 'user03@sldkf' AND MEMBER_DEL_FL = 'N';

SELECT COUNT(*) FROM MEMBER WHERE MEMBER_EMAIL = '#{email}' AND MEMBER_DEL_FL = 'N';
...
FROM MEMBER
WHERE MEMBER_EMAIL = 'user03@sldkf'
AND MEMBER_DEL_FL = 'N';
...
SELECT * FROM "COMMENT"; -- 예약어로 인식해서 따옴표 넣어줘야 함

-- 게시글 샘플 이미지
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142001_00001.jpg', 'cat1.jpg', 0, 1493);
        
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142010_00002.jpg', 'cat2.jpg', 0, 1489);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142010_00003.jpg', 'cat3.jpg', 0, 1488);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142010_00004.jpg', 'cat4.jpg', 0, 1484);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
        '20230821142010_00005.jpg', 'cat5.jpg', 0, 1473);
...
SELECT COUNT(*)
FROM BOARD_LIKE L
WHERE L.BOARD_NO = 1493;

-- 특정 게시글에 대한 이미지 조회(IMG_ORDER 오름차순)
SELECT * FROM BOARD_IMG WHERE BOARD_NO = 1493 
ORDER BY IMG_ORDER;

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', 
        '20230821142010_00003.jpg','cat2.jpg',1,1493);
        
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', 
        '20230821142010_00004.jpg','cat4.jpg',2,1493);
...
ORDER BY COMMENT_NO
;
select * from "COMMENT" where board_no = 1493;


-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG='/resources/images/member/monkey.gif'
WHERE MEMBER_NO=1;
...
WHERE BOARD_NO = 1493 -- 게시글 번호
AND MEMBER_NO = 1; -- 로그인한 회원 번호

-- 좋아요 삽입
INSERT INTO BOARD_LIKE VALUES(1493, 13);

-- 좋아요 삭제
DELETE FROM BOARD_LIKE WHERE BOARD_NO = 1493 AND MEMBER_NO = 1;
...
SELECT READ_COUNT FROM BOARD WHERE BOARD_NO = 1493;

-- 프로필 이미지 수정
UPDATE MEMBER SET PROFILE_IMG = 'SF' WHERE MEMBER_NO = 1;
...
FROM (SELECT '웹 접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
        0 IMG_ORDER, 1509 BOARD_NO FROM DUAL
        
        UNION ALL

        SELECT '웹 접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
                1 IMG_ORDER, 1509 BOARD_NO FROM DUAL
        
        UNION ALL

        SELECT '웹 접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
                2 IMG_ORDER, 1509 BOARD_NO FROM DUAL)A;
                
SELECT * FROM BOARD_IMG WHERE BOARD_NO = 1509;
...
SELECT '웹 접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
        2 IMG_ORDER, 1509 BOARD_NO FROM DUAL;
        
-- 게시글 수정
UPDATE BOARD SET BOARD_TITLE = 'DFD', BOARD_CONTENT = 'SFDS', B_UPDATE_DATE = SYSDATE 
WHERE BOARD_NO = 1500;
...
-- 1001, 1002
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 1', DEFAULT, DEFAULT, 1520,1,NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 2', DEFAULT, DEFAULT, 1520,1,NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-1', DEFAULT, DEFAULT, 1520,1,1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-2', DEFAULT, DEFAULT, 1520,1,1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 1-3', DEFAULT, DEFAULT, 1520,1,1001);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-1', DEFAULT, DEFAULT, 1520,1,1002);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-2', DEFAULT, DEFAULT, 1520,1,1002);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식댓글 2-1-1', DEFAULT, DEFAULT, 1520,1,1006);
...
UPDATE "COMMENT" SET
		COMMENT_DEL_FL = 'Y'
WHERE COMMENT_NO IN (SELECT COMMENT_NO FROM "COMMENT" WHERE PARENT_NO = 1001);

UPDATE "COMMENT" SET
		COMMENT_DEL_FL = 'N'
		WHERE COMMENT_NO = 1001
        OR COMMENT_NO IN (SELECT COMMENT_NO FROM "COMMENT" WHERE PARENT_NO = 1001);
